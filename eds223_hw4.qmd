...
bathymetry <- depth.tif
  
maritime_boundaries <- wc_regions_clean.shp

```

```{r}
# Create a raster stack of the SST tif files (or should i do this lower down?...or do it again later down?)
```
