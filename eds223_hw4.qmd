...
```{r}
print(res(sst_average_celsius))
print(res(bathymetry))
```
This check confirms my suspicions, and I decide to resample the bathymetry data to match the resolution of the SST data, using the nearest neighbor approach.
...
# Verify the results
print(res(sst_average_celsius))
print(res(bathymetry_resampled))

# Check that the depth and SST match in resolution, extend, and CRS (hint: can the rasters be stacked?)
```
Now that the resolutions and CRS of the data matches, I can crop the bathymetry raster to match the extent of the SST raster. 
...
# Print the results
print(paste("Resolution match:", res_match))
print(paste("Extent match:", extent_match))
print(paste("CRS match:", crs_match))
